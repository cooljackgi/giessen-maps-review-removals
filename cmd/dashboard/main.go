...
var (
	...
	defaultOutput = "output/charts/" + mapsreview.ActiveCity.Slug + "_dashboard.html"
)
...
func parseArgs(argv []string) (args, error) {
  ...
  go run ./cmd/dashboard --input output/places.json --output output/charts/` + mapsreview.ActiveCity.Slug + `_dashboard.html`)
			os.Exit(0)
		default:
